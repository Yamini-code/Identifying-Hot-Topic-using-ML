"""identifying_hot_topic_trends URL Configuration
...
from identifying_hot_topic_trends import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Identifying_Hot_Topic_Trends/$', remoteuser.Predict_Identifying_Hot_Topic_Trends, name="Predict_Identifying_Hot_Topic_Trends"),
    ...
    url(r'^View_Predicted_Identifying_Hot_Topic_Trends_Ratio/$', serviceprovider.View_Predicted_Identifying_Hot_Topic_Trends_Ratio, name="View_Predicted_Identifying_Hot_Topic_Trends_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Identifying_Hot_Topic_Trends/$', serviceprovider.View_Predicted_Identifying_Hot_Topic_Trends, name="View_Predicted_Identifying_Hot_Topic_Trends"),
