...
--
-- Host: localhost
-- Generation Time: Sep 20, 2023 at 06:47 AM
...
--
-- Database: `identifying_hot_topic_trends`
--
CREATE DATABASE IF NOT EXISTS `identifying_hot_topic_trends` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `identifying_hot_topic_trends`;
...
('1parmjqueori81l05qhyvg4ngdm8lpy7', 'eyJ1c2VyaWQiOjF9:1qghOI:6QdC2zgzRxld0lp13tkEgdsYKZUfx_wEOTDMk9-zzNY', '2023-09-28 08:07:58.984755'),
('416itlo1zgwa5kw93ze1u9b7s2gdvtys', 'eyJ1c2VyaWQiOjJ9:1qgjJi:mNJFyAWj4XZtRmyptd_7VseKd74ekT1u4E578e7pU_g', '2023-09-28 10:11:22.842208'),
...
(2, 'Manjunath', 'Manjunath123@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '', '');
...
(1, 'Naive Bayes', '76.56441717791411'),
(2, 'SVM', '77.66871165644172'),
(3, 'Logistic Regression', '78.65030674846626'),
(4, 'Decision Tree Classifier', '68.58895705521473'),
(5, 'GradientBoostingClassifier', '74.84662576687117');
...
(13, 'Hot Topic', '40.0'),
(14, 'Normal Topic', '60.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_hot_topic`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_hot_topic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Sno` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_predict_hot_topic`
--

INSERT INTO `remote_user_predict_hot_topic` (`id`, `Sno`, `PDate`, `Headline`, `Description`, `Source`, `Prediction`) VALUES
(1, '8', '30-04-20', 'Journalist among 10 new COVID-19 cases reported in Kerala\r\n', 'Kerala Chief Minister Pinarayi Vijayan on Wednesday said that a television journalist and three healthcare workers were among the ten people who tested positive for COVID-19 in Kerala. Of the new cases, six were reported from Kollam, two each from Kasargod and Thiruvananthapuram. There are 495 coronavirus cases in the state.\r\n', 'https://www.newindianexpress.com/states/kerala/2020/apr/29/journalist-among-ten-new-covid-19-cases-reported-in-kerala-2136978.html?utm_campaign=fullarticle&utm_medium=referral&utm_source=inshorts', 'Normal Topic'),
(2, '11', '30-04-20', 'Sanitation worker donates 1 month''s salary to Telangana CM Relief Fund\r\n', 'A sanitation worker, A Alivelu, in Telangana''s Hyderabad, donated her one month''s salary of â‚¹10,000 to CM Relief Fund on Tuesday. She handed over the cheque to IT Minister KT Rama Rao who tweeted and said Alivelu didn''t want anything in return and insisted him to accept the donation. Alivelu''s husband is a daily wage labourer at a vegetable market.\r\n', 'https://www.newindianexpress.com/states/telangana/2020/apr/29/sanitation-worker-donates-rs-10000-to-telangana-cm-relief-fund-2136675.html?utm_campaign=fullarticle&utm_medium=referral&utm_source=inshorts', 'Hot Topic'),
(3, '15', '30-04-20', '10 test +ve in Haryana''s Jhajjar district, 9 had travelled to Delhi\r\n', 'Ten fresh cases of coronavirus have been reported in Haryana''s Jhajjar district, taking the total number of cases in the district to 18, Chief Medical Officer Dr Randeep Puniya stated. Among the fresh cases, nine are vegetable vendors who have a history of travelling to Delhi and one is a nurse at a hospital. Haryana has over 300 COVID-19 cases. \r\n', 'https://www.financialexpress.com/lifestyle/health/coronavirus-in-india-live-updates-lockdown-extension-guidelines-covid-19-tracker-latest-news-state-wise-delhi-maharashtra-up/1943824/?utm_campaign=fullarticle&utm_medium=referral&utm_source=inshorts', 'Normal Topic'),
(4, '28', '29-04-20', 'Coronavirus cases rise to 2,162 in Tamil Nadu; 1,210 patients discharged\r\n', 'Tamil Nadu on Wednesday reported 104 new coronavirus cases, taking the total number of cases in the state to 2,162. As many as 1,210 patients have been cured and discharged in Tamil Nadu till today, while 27 people have lost their lives to COVID-19. There are 922 active cases in the state.\r\n', 'https://twitter.com/pibchennai/status/1255492468340068355?utm_campaign=fullarticle&utm_medium=referral&utm_source=inshorts', 'Normal Topic'),
(5, '131', '28-04-20', 'COVID-19 patients with very mild symptoms can self-isolate, govt issues guidelines\r\n', 'The government has said that COVID-19 patients with very mild symptoms or those who are pre-symptomatic can opt for home isolation if they have requisite self-isolation facility at their residence. The patients must have a caregiver at home on a 24x7 basis. They must regularly inform District Surveillance Officer about their health status and download Aarogya Setu app on mobile.\r\n', 'https://www.deccanherald.com/national/union-health-ministry-issues-new-guidelines-for-home-isolation-of-people-with-very-mild-symptoms-of-coronavirus-830870.html?utm_campaign=fullarticle&utm_medium=referral&utm_source=inshorts', 'Hot Topic');
